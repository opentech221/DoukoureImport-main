...
export default function CartSheet({ items, onClose, onRemove }: Props) {
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="absolute bottom-0 left-0 right-0 mx-auto max-h-[90vh] max-w-md overflow-y-auto rounded-t-3xl bg-white shadow-2xl lg:bottom-1/2 lg:max-w-lg lg:translate-y-1/2 lg:rounded-3xl"
      >
